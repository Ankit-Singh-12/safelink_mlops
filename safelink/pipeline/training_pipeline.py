...
from safelink.entity.config_entity import(
...
from safelink.constant.training_pipeline import TRAINING_BUCKET_NAME
from safelink.constant.training_pipeline import SAVED_MODEL_DIR
from safelink.cloud.s3_syncer import S3Sync
import sys
...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            logging.info(f"Data Initiation process completed and artifact: {data_ingestion_artifact}")
    ...
    def start_data_transformation(self,data_validation_artifact:DataValidationArtifact):
        try:
            ...
            logging.info(f"Data Transformation process completed and artifact: {data_transformation_artifact}")
