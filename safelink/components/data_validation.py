from safelink.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact
from safelink.entity.config_entity import DataValidationConfig
from safelink.exception.exception import SafeLinkException 
from safelink.logging.logger import logging 
from safelink.constant.training_pipeline import SCHEMA_FILE_PATH
from scipy.stats import ks_2samp
import pandas as pd
import os,sys
from safelink.utils.main_utils.utils import read_yaml_file,write_yaml_file
...
class DataValidation:
    ...
    def validate_numerical_columns(self, dataframe: pd.DataFrame) -> bool:
        try:
            expected = self._schema_config["numerical_columns"]    
